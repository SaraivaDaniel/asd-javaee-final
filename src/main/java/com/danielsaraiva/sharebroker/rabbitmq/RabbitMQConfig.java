...
public class RabbitMQConfig implements RabbitListenerConfigurer {
	...
	public static final String QUEUE_MESSAGES = "sharebroker-orders";
    public static final String EXCHANGE_MESSAGES = "sharebroker-exchange";
    public static final String QUEUE_DEAD_MESSAGES = "sharebroker-ordersdeadqueue";
